...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 120; // Mota: 2 minute
        nTargetSpacing = 1 * 120;  // Mota: 2 minute
        nLastPOWBlock = 10080;
        nMaturity = 90;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "2017-09-21 22:01:04 : Bitcoin Block Hash for Height 486382 : 00000000000000000092d15e5b3e6e8269398a84a60ae5a2dbd4e7f431199d03";
        ...
        vSeeds.push_back(CDNSSeedData("presstab", "Motaseed.presstab.pw"));
...
public:
    CTestNetParams()
    {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet Mota addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet Mota script addresses start with '8' or '9'
