                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Mota from zMOTA"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zMOTA"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zMOTA));
