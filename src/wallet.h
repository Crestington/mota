...
// Possible states for zMOTA send
enum ZerocoinSpendStatus {
    ZMOTA_SPEND_OKAY = 0,                            // No error
    ZMOTA_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZMOTA_WALLET_LOCKED = 2,                         // Wallet was locked
    ZMOTA_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZMOTA_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZMOTA_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZMOTA_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZMOTA_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZMOTA_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZMOTA_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZMOTA_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZMOTA_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZMOTA_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZMOTA_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZMOTA_SPENT_USED_ZMOTA = 14,                     // Coin has already been spend
    ZMOTA_TX_TOO_LARGE = 15                          // The transaction is larger than the max tx size
};
...
public:
    ...
    */
    ...
    void setZMotaAutoBackups(bool fEnabled)
    {
